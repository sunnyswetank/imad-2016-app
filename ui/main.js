function loadLoginForm () {
    var loginHtml = `
        <div class="logindiv">
        <input type="text" class="w3-btn w3-medium w3-round-xlarge" id="username" placeholder="username" />
        <input type="password" class="w3-btn w3-medium w3-round-xlarge" id="password" placeholder="password" />
        <br/><br/>
